...
import { useCreateVoucherMutation } from "../../../state/api/voucherApi";
...
const AddVoucher = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await createVoucher(dataToSubmit).unwrap();
      iziToast.success({
        title: "Success",
      ...
      iziToast.error({
        title: "Error",
        message:
          err.data?.message || "An error occurred while creating the voucher",
        position: "topRight",
        timeout: 3000,
      });
    }
